...
#define EXT4_FITS_IN_INODE(ext4_inode, einode, field)             \
	((offsetof(typeof(*ext4_inode), field) +                      \
	  sizeof((ext4_inode)->field)) <= (EXT4_GOOD_OLD_INODE_SIZE + \
...
#define EXT4_DIRENT_HASHES(entry)                       \
	((struct ext4_dir_entry_hash *)(((void *)(entry)) + \
...
{
	return ext4_has_feature_largedir(sb) ? EXT4_HTREE_LEVEL : EXT4_HTREE_LEVEL_COMPAT;
}
...
extern int ext4_punch_hole_impl(handle_t *handle, struct inode *inode,
								loff_t offset, loff_t length, int relink);
...
extern __printf(6, 7) void __ext4_error_inode(struct inode *, const char *, unsigned int,
											  ext4_fsblk_t, int, const char *, ...);
extern __printf(5, 6) void __ext4_error_file(struct file *, const char *, unsigned int, ext4_fsblk_t,
											 const char *, ...);
extern void __ext4_std_error(struct super_block *, const char *,
							 unsigned int, int);
extern __printf(4, 5) void __ext4_warning(struct super_block *, const char *, unsigned int,
										  const char *, ...);
extern __printf(4, 5) void __ext4_warning_inode(const struct inode *inode, const char *function,
												unsigned int line, const char *fmt, ...);
extern __printf(3, 4) void __ext4_msg(struct super_block *, const char *, const char *, ...);
extern void __dump_mmp_msg(struct super_block *, struct mmp_struct *mmp,
						   const char *, unsigned int, const char *);
extern __printf(7, 8) void __ext4_grp_locked_error(const char *, unsigned int,
...
#define ext4_read_incompat_64bit_val(es, name)                            \
	(((es)->s_feature_incompat & cpu_to_le32(EXT4_FEATURE_INCOMPAT_64BIT) \
		  ? (ext4_fsblk_t)le32_to_cpu(es->name##_hi) << 32                \
		  : 0) |                                                          \
...
static inline struct ext4_group_info *ext4_get_group_info(struct super_block *sb,
														  ext4_group_t group)
{
...
static const unsigned char ext4_type_by_mode[(S_IFMT >> S_SHIFT) + 1] = {
	...
	[S_IFDIR >>
		S_SHIFT] = EXT4_FT_DIR,
	[S_IFCHR >>
		S_SHIFT] = EXT4_FT_CHRDEV,
	[S_IFBLK >>
		S_SHIFT] = EXT4_FT_BLKDEV,
	[S_IFIFO >>
		S_SHIFT] = EXT4_FT_FIFO,
	[S_IFSOCK >>
		S_SHIFT] = EXT4_FT_SOCK,
	[S_IFLNK >>
...
extern int ext4_meta_swap_extents(handle_t *handle, struct inode *inode1,
								   struct inode *inode2, ext4_lblk_t lblk1,
								   ext4_lblk_t lblk2, ext4_lblk_t count, int *err);
